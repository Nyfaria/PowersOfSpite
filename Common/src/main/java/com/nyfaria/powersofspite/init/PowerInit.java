...
import com.nyfaria.powersofspite.power.DisplacerPower;
...
import com.nyfaria.powersofspite.power.SpatialTravelPower;
import com.nyfaria.powersofspite.power.SuperSpeedPower;
import com.nyfaria.powersofspite.power.SuperStrengthPower;
import com.nyfaria.powersofspite.power.TeleportationPower;
...
public class PowerInit {
    public static ResourceKey<Registry<Power>> POWER_KEY = ResourceKey.createRegistryKey(SpiteConstants.modLoc("power"));
    public static RegistrationProvider<Power> POWERS = RegistrationProvider.get(POWER_KEY, SpiteConstants.MODID);
    ...
    public static RegistryObject<Power> DISPLACER = POWERS.register("displacer", DisplacerPower::new);
    public static RegistryObject<Power> SPATIAL_TRAVEL = POWERS.register("spatial_travel", SpatialTravelPower::new);
